 ...
 */ ;(function (Ct, ce) {
  ;(function (l, St) {
    ...
    var fe = 0
    function x(t) {
      return '_leaflet_id' in t || (t._leaflet_id = ++fe), t._leaflet_id
    }
    function $e(t, e, i) {
      var n, o, s, r
      return (
    ...
    function S(t, e) {
      Object.prototype.hasOwnProperty.call(t, 'options') ||
        (t.options = t.options ? it(t.options) : {})
    ...
    var yn = /\{ *([\w_ -]+) *\}/g
    function ti(t, e) {
      return t.replace(yn, function (i, n) {
        var o = e[n]
    ...
    function D(t, e, i) {
      if (i && pe === ii) t.call(e)
      else return pe.call(window, M(t, e))
    }
    function G(t) {
      t && ni.call(window, t)
    }
    ...
    ;(nt.extend = function (t) {
      ...
      return (
        ...
        t.includes && (xn(t.includes), T.apply(null, [n].concat(t.includes))),
        T(n, t),
        delete n.statics,
        delete n.includes,
        n.options &&
          ((n.options = i.options ? it(i.options) : {}),
    ...
    F.prototype = {
      ...
      pad: function (t) {
        ...
        return new F(new b(e.lat - n, e.lng - o), new b(i.lat + n, i.lng + o))
      },
      getCenter: function () {
        return new b(
    ...
    var we = document.documentElement.style,
      ...
      Ln = qt && !document.addEventListener,
      hi = 'msLaunchUri' in navigator && !('documentMode' in document),
      xe = $('webkit'),
      ui = $('android'),
      li = $('android 2') || $('android 3'),
      Tn = parseInt(/WebKit\/([0-9]+)|$/.exec(navigator.userAgent)[1], 10),
      bn = ui && $('Google') && Tn < 537 && !('AudioNode' in window),
      Pe = !!window.opera,
      ci = !hi && $('chrome'),
      fi = $('gecko') && !xe && !Pe && !qt,
      Mn = !ci && $('safari'),
      ...
      Cn = navigator.platform.indexOf('Win') === 0,
      mi = qt && 'transition' in we,
      Le =
      ...
      Dn = navigator.platform.indexOf('Mac') === 0,
      Hn = navigator.platform.indexOf('Linux') === 0
    function $(t) {
    ...
    var f = {
      ...
      Ti = { touchstart: qn, touchmove: jt, touchend: jt, touchcancel: jt },
      gt = {},
      bi = !1
    function Fn(t, e, i) {
      return (
    ...
    function Vn() {
      bi ||
        (document.addEventListener(wi, Un, !0),
        document.addEventListener(xi, Gn, !0),
    ...
    var Me = Xt([
      ...
      Ci =
        Ot === 'webkitTransition' || Ot === 'OTransition'
          ? Ot + 'End'
          : 'transitionend'
    function Si(t) {
    ...
    function Ne(t, e, i, n, o) {
      ...
      !f.touchNative && f.pointer && e.indexOf('touch') === 0
        ...
        ? t.removeEventListener(Be[e] || e, s, !1)
    ...
    function Rt(t) {
      return (
        p(t, 'mousedown touchstart dblclick contextmenu', mt),
      ...
      w = kt.extend({
        ...
        initialize: function (t, e) {
          ;(e = S(this, e)),
            ...
            this._zoomAnimated &&
              ...
              p(this._proxy, Ci, this._catchTransitionEnd, this)),
        ...
        setView: function (t, e, i) {
          if (
            ...
            i.animate !== void 0 &&
              ...
              (i.pan = T({ animate: i.animate, duration: i.duration }, i.pan)))
            var n =
              this._zoom !== e
        ...
        flyTo: function (t, e, i) {
          ...
          function g(B) {
            var le = B ? -1 : 1,
              Uo = B ? h : a,
              Go = h * h - a * a + le * d * d * u * u,
              Vo = 2 * Uo * d * u,
              Xe = Go / Vo,
              mn = Math.sqrt(Xe * Xe + 1) - Xe,
              qo = mn < 1e-9 ? -18 : Math.log(mn)
            return qo
          }
          function R(B) {
          ...
          var W = g(0)
          function Mt(B) {
            return a * (A(W) / A(W + c * B))
          }
          function Do(B) {
            return (a * (A(W) * j(W + c * B) - R(W))) / d
          }
          function Ho(B) {
          ...
          var Fo = Date.now(),
            dn = (g(1) - W) / c,
            Wo = i.duration ? 1e3 * i.duration : 1e3 * dn * 0.8
          function _n() {
            var B = (Date.now() - Fo) / Wo,
              le = Ho(B) * dn
            B <= 1
              ? ((this._flyToFrame = D(_n, this)),
                this._move(
                  this.unproject(
                    n.add(o.subtract(n).multiplyBy(Do(le) / u)),
                    r,
                  ),
    ...
    w.mergeOptions({ zoomControl: !0 }),
      w.addInitHook(function () {
        this.options.zoomControl &&
          ((this.zoomControl = new He()), this.addControl(this.zoomControl))
      })
    var no = function (t) {
        return new He(t)
      },
      ...
      lt = kt.extend({
        ...
        disable: function () {
          this._enabled &&
            ...
            C(this._dragStartTarget, Ni, this._onDown, this),
            (this._enabled = !1),
            (this._moved = !1))
        },
        _onDown: function (t) {
          if (
            ...
            if (
              ...
              ;(this._startPoint = new m(e.clientX, e.clientY)),
                (this._startPos = _t(this._element)),
    ...
    function Ri(t, e, i) {
      var n,
        ...
        d,
        g
      for (s = 0, c = t.length; s < c; s++) t[s]._code = vt(t[s], e)
      for (a = 0; a < 4; a++) {
        for (d = o[a], n = [], s = 0, c = t.length, r = c - 1; s < c; r = s++)
          (h = t[s]),
            ...
            h._code & d
              ? u._code & d ||
                ((g = Qt(u, h, d, e, i)), (g._code = vt(g, e)), n.push(g))
              : (u._code & d &&
                  ((g = Qt(u, h, d, e, i)), (g._code = vt(g, e)), n.push(g)),
                n.push(h))
        t = n
    ...
    function Vi(t, e) {
      ...
      for (i = 0; i < R; i++) {
        var j = y(t[i])
        A.push(e.project(y([j.lat - c.lat, j.lng - c.lng])))
      }
      for (i = 0, n = 0; i < R - 1; i++) n += A[i].distanceTo(A[i + 1]) / 2
      if (n === 0) u = A[0]
      else
        for (i = 0, s = 0; i < R - 1; i++)
          if (
            ((r = A[i]), (a = A[i + 1]), (o = r.distanceTo(a)), (s += o), s > n)
          ) {
            ;(h = (s - n) / o),
    ...
    var _o = {
      ...
      mo = { __proto__: null, LonLat: Ge, Mercator: Ve, SphericalMercator: ve },
      po = T({}, ut, {
        code: 'EPSG:3395',
        projection: Ve,
        transformation: (function () {
    ...
    var rt = ct.extend({
      ...
      closestLayerPoint: function (t) {
        for (
          var e = 1 / 0, i = null, n = Ht, o, s, r = 0, a = this._parts.length;
          r < a;
          r++
        )
    ...
    function ie(t, e) {
      ...
      switch (i.type) {
        ...
        case 'MultiLineString':
          return (h = ne(n, i.type === 'LineString' ? 0 : 1, r)), new rt(h, e)
        case 'Polygon':
        case 'MultiPolygon':
    ...
    function ne(t, e, i) {
      for (var n = [], o = 0, s = t.length, r; o < s; o++)
        (r = e ? ne(t[o], e - 1, i) : (i || je)(t[o])), n.push(r)
      return n
    }
    function Ke(t, e) {
      return (
    ...
    function oe(t, e, i, n) {
      for (var o = [], s = 0, r = t.length; s < r; s++)
        o.push(e ? oe(t[s], q(t[s]) ? 0 : e - 1, i, n) : Ke(t[s], n))
      return !e && i && o.length > 0 && o.push(o[0].slice()), o
    }
    function Tt(t, e) {
      return t.feature ? T({}, t.feature, { geometry: e }) : se(e)
    }
    function se(t) {
    ...
    var Ye = {
      toGeoJSON: function (t) {
        return Tt(this, { type: 'Point', coordinates: Ke(this.getLatLng(), t) })
      },
    }
    te.include(Ye),
      qe.include(Ye),
      ...
      Lt.include({
        toGeoJSON: function (t) {
          var e = !q(this._latlngs),
            ...
            n = oe(this._latlngs, i ? 2 : e ? 1 : 0, !0, t)
          return (
            e || (n = [n]),
        ...
        onAdd: function (t) {
          et.prototype.onAdd.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof ct || this._source.on('preclick', mt))
        },
        onRemove: function (t) {
          et.prototype.onRemove.call(this, t),
            ...
            this._source &&
              ...
              this._source instanceof ct || this._source.off('preclick', mt))
        },
        getEvents: function () {
    ...
    w.mergeOptions({ closePopupOnClick: !0 }),
      ...
      X.include({
        bindPopup: function (t, e) {
          return (
            (this._popup = this._initOverlay(ae, this._popup, t, e)),
            ...
            for (var d = o.min.y; d <= o.max.y; d++)
              for (var g = o.min.x; g <= o.max.x; g++) {
                ...
                if (((R.z = this._tileZoom), !!this._isValidTile(R))) {
                  var A = this._tiles[this._tileCoordsToKey(R)]
                  A ? (A.current = !0) : r.push(R)
                }
              }
            if (
              (r.sort(function (W, Mt) {
    ...
    var bt = Wt.extend({
      ...
      getTileUrl: function (t) {
        ...
        return ti(this._url, T(e, this.options))
      },
      ...
      _removeTile: function (t) {
        ...
        if (e)
          return (
            e.el.setAttribute('src', Vt), Wt.prototype._removeTile.call(this, t)
          )
      },
      _tileReady: function (t, e, i) {
    ...
    var tn = bt.extend({
      ...
      getTileUrl: function (t) {
        ...
        return (
          a +
          Qe(this.wmsParams, a, this.options.uppercase) +
    ...
    var ht = X.extend({
        ...
        _updateTransform: function (t, e) {
          ...
          f.any3d ? dt(this._container, s, i) : I(this._container, s)
        },
        _reset: function () {
    ...
    ;(Gt.create = ue),
      (Gt.pointsToPath = ai),
      (at.geometryToLayer = ie),
      (at.coordsToLatLng = je),
      (at.coordsToLatLngs = ne),
      (at.latLngToCoords = Ke),
      (at.latLngsToCoords = oe),
      (at.getFeature = Tt),
      (at.asFeature = se),
...
var hs = Je.exports
const pn = jo(hs),
  us = (Ct) => (ns('data-v-0c2a4af1'), (Ct = Ct()), os(), Ct),
  ls = us(() => gn('div', { id: 'map', class: 'map-container' }, null, -1)),
  cs = { class: 'returnBack' },
  fs = vn({ name: 'initMap', labelName: '初始化地图', componentIndex: 1 }),
  ds = vn({
    ...fs,
    setup(Ct) {
      const ce = Yo()
      ...
      const l = () => {
          let T = pn.map('map').setView([39.90002, 116.46], 10)
          const it = '37d883978b54bc12f58d30492062d574'
          return (
            pn
              .tileLayer(
                `http://t{s}.tianditu.gov.cn/vec_w/wmts?service=wmts&request=GetTile&version=1.0.0&LAYER=vec&tileMatrixSet=w&TileMatrix={z}&TileRow={y}&TileCol={x}&style=default&format=tiles&tk=${it}`,
                {
                  maxZoom: 13,
            ...
            gn('div', cs, [
              ts(
                M,
                {
                  type: 'primary',
                  icon: is(rs),
                  onClick: it[0] || (it[0] = (fe) => St()),
                },
                { default: es(() => [ss(' 返回 ')]), _: 1 },
                8,
                ['icon'],
              ),
            ]),
...
const ms = as(ds, [['__scopeId', 'data-v-0c2a4af1']])
